    ...
    <div class="col-xs-11 col-md-9 col-lg-10 padding-zero dashboard-tab-area job-applicants">
        ...
        <div class="dashboard-tab-inner">
            ...
            <div class="dashboard-top-filter">
                ...
                <div class="col-xs-4">
                    <p class="job-notice uppercase">You have invited <span class="accent-color"><b>3</b></span> jobsekeers to join the team</p>
                </div>
                <div class="col-xs-4">
            ...
            <div class="row dashboard-tab-content">
                <div class="form-sec applicant-item">
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="applicant-content profile-meta">
                            <h3 class="applicant-name"><a href="#" class="accent-color">Raffy Ilagan</a><span class="accent-color-2 uppercase">Part-time</span><span class="accent-color-2"><i class="icon-hiring-accepted"></i>This Jobseeker has accepted your invite!</span></h3>
                            ...
                            <p>Invited in <a href="#" class="dashed">Adobe Illustrator | Photoshop Graphic Designer Wanted!</a></p>
                            <p><a href="#" class="btn-secondary uppercase right-margin">View Profile</a><a href="#" class="btn-secondary uppercase btn-cancel right-margin">Cancel Invitation</a></p>
                        </div>
                        <span class="clearfix"></span>
                    </div>
                ...
                <div class="form-sec applicant-item">
                    <div class="col-lg-8 col-md-12">
                        <img src="{{ asset('img/sample-author-2.png') }}" width="65" height="65">
                        <div class="applicant-content profile-meta">
                            <h3 class="applicant-name"><a href="#" class="accent-color">Raffy Ilagan</a><span class="accent-color-2 uppercase">Part-time</span><span class="accent-color"><i class="icon-hiring-process"></i>Currently waiting for Jobseeker’s decision.</span></h3>
                            <p class="uppercase">Concept Artist and Illustrator</p>
                            <div class="star-review" title="Rated 4.5 out of 5"><span style="width:90%"><strong class="rating">4.5</strong> out of 5</span></div>
                            <p class="rating-num">4.5 <span>(3 reviews)</span></p>
                            <p>Invited in <a href="#" class="dashed">Adobe Illustrator | Photoshop Graphic Designer Wanted!</a></p>
                ...
                <div class="form-sec applicant-item">
                    <div class="col-lg-8 col-md-12">
                        <img src="{{ asset('img/sample-author-2.png') }}" width="65" height="65">
                        <div class="applicant-content profile-meta">
                            <h3 class="applicant-name"><a href="#" class="accent-color">Raffy Ilagan</a><span class="accent-color-2 uppercase">Part-time</span><span class="error-color"><i class="icon-hiring-rejected"></i>This Jobseeker has rejected your invite.</span></h3>
                            <p class="uppercase">Concept Artist and Illustrator</p>
                            <div class="star-review" title="Rated 4.5 out of 5"><span style="width:90%"><strong class="rating">4.5</strong> out of 5</span></div>
                            <p class="rating-num">4.5 <span>(3 reviews)</span></p>
                            <p>Invited in <a href="#" class="dashed">Adobe Illustrator | Photoshop Graphic Designer Wanted!</a></p>
