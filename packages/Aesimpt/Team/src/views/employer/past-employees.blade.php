    ...
    <div class="col-xs-11 col-md-9 col-lg-10 padding-zero dashboard-tab-area job-applicants">
        ...
        <div class="dashboard-tab-inner">
            ...
            <div class="dashboard-top-filter">
                ...
                <div class="col-xs-4">
                    <p class="job-notice uppercase">You have <span class="accent-color"><b>3</b></span> past employees</p>
                </div>
                <div class="col-xs-4">
                ...
                <div class="form-sec applicant-item">
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="applicant-content profile-meta">
                            ...
                            <p><a href="#invite-seeker" data-toggle="modal" class="btn-secondary uppercase right-margin">Invite for Job</a><a href="#" class="btn-secondary uppercase right-margin">View Profile</a></p>
                        </div>
                        <span class="clearfix"></span>
                    </div>
