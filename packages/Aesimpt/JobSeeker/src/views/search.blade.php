...
@section('content')
    ...
    <div class="col-xs-11 col-md-9 col-lg-10 padding-zero dashboard-tab-area job-applicants">
        <h2 class="dashboard-tab-area-title"><span class="icon-jobs-search"></span>Search Jobs Seekers</h2>
                ...
                <div class="form-sec applicant-item">
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="applicant-content profile-meta">
                            ...
                            <p><a href="#" class="btn-secondary uppercase right-margin">View Profile</a><a href="#" class="btn-secondary uppercase right-margin">Bookmark Jobseeker</a><a href="#invite-seeker" data-toggle="modal" class="btn-secondary uppercase right-margin">Invite for job</a></p>
                        </div>
                        <span class="clearfix"></span>
                    </div>
