...
@section('content')
    ...
    <div class="col-xs-11 col-md-9 col-lg-10 padding-zero dashboard-tab-area">
        <h2 class="dashboard-tab-area-title"><span class="icon-jobs-active"></span>Update Job</h2>
        <div class="dashboard-tab-inner">
            <div class="row dashboard-tab-content">
                {{ Form::open(['url' => route('employer-job.update', $job->id), 'class'=>'dashboard-form', 'method' => 'PUT']) }}
                <div class="col-md-6">
                    <div class="form-sec">
                        ...
                        {{
                            Form::text(
                                'position',
                                (!empty(old('position'))) ? old('position') : $job->position,
                                [
                                    'name'=>'position'
                                ]
                            )
                    ...
                    <div class="form-sec">
                        ...
                        {{
                             Form::select(
                                ...
                                (!empty(old('hours'))) ? old('hours') : $job->hours,
                                [
                    ...
                    <div class="form-sec">
                        ...
                        {{
                            Form::select(
                                ...
                                (!empty(old('salary'))) ? old('salary') : $job->salary,
                                [
                    ...
                    <div class="form-sec">
                        ...
                        <p>
                            {{
                                Form::textarea(
                                    'skills',
                                    (!empty(old('skills'))) ? old('skills') : implode(',', $job->skills),
                                    [
                ...
                <div class="col-md-6">
                    <div class="form-sec">
                        ...
                        {{
                             Form::textarea(
                                 'description',
                                 (!empty(old('description'))) ? old('description') : $job->description,
                                 [
                                     'placeholder'=>''
                                 ]
                             )
                ...
                <div class="submit-area">
                    {{ Form::submit('Update This Job', ['name'=>'update', 'class'=>'btn-secondary btn-small']) }}
