...
<body>
    ...
    <header id="header-wrap" class="container padding-zero">
        <div class="col-xs-3 col-lg-2 padding-zero logo-holder">
            <a href="#" class="logo"><img src="../img/oes-logo.png" width="226" height="23" /></a>
        </div>
                ...
                <div class="top-author">
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Rafael Ilagan
                            ...
                            <img src="../img/sample-author.png" class="author-img" width="45" height="45">
                        </button>
    ...
    <div id="oes-dashboard" class="container padding-zero employer-dashboard">
        <div class="col-xs-1 col-md-3 col-lg-2 padding-zero dashboard-sidebar">
            <div class="author-welcome">
                <img src="../img/sample-author-2.png" width="65" height="65">
                <h1><span>Welcome,</span> Rafael!</h1>
                <span class="clearfix"></span>
            </div>

            <nav class="sidebar-nav">
                <ul>
                   <li><a href="#"><span class="nav-icon icon-my-profile"></span>My profile</a></li>
                   <li class="active"><a href="#"><span class="nav-icon icon-my-account"></span>My Account</a></li> 
                   <li><a href="#"><span class="nav-icon icon-my-inbox"></span>My Inbox</a></li> 
                   <li><a href="#"><span class="nav-icon icon-jobs-active"></span>Post a new Job</a></li>
                   <li><a href="#"><span class="nav-icon icon-jobs-applied"></span>My Job Posts</a></li> 
                   <li><a href="#"><span class="nav-icon icon-jobs-invited"></span>Job Applicants</a></li>
                   <li><a href="#"><span class="nav-icon icon-team"></span>My Team</a></li>
                   <li><a href="#"><span class="nav-icon icon-team-workplace"></span>Team Workplace</a></li> 
                   <li><a href="#"><span class="nav-icon icon-jobs-bookmarked"></span>Bookmarked Seekers</a></li>  
                   <li><a href="#"><span class="nav-icon icon-jobs-search"></span>Search Jobs Seekers</a></li> 
                </ul>
            </nav>
