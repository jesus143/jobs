...
<header id="header-wrap" class="container padding-zero">
    <div class="col-xs-3 col-lg-2 padding-zero logo-holder">
        <a href="{{ route('jobseeker-profile.signup-select-skills') }}" class="logo"><img src="{{ asset('img/oes-logo.png') }}" width="226" height="23" /></a>
    </div>
    ...
    <div class="col-xs-9 col-lg-10 top-actions">
        ...
        <div class="top-author">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="{{ route('jobseeker-profile.signup-select-skills') }}"><span class="nav-icon icon-my-account"></span>My Profile</a></li>
